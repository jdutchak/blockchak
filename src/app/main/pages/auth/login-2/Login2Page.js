            ...
            <div className="flex flex-col flex-grow-0 items-center text-white p-16 text-center md:p-128 md:items-start md:flex-shrink-0 md:flex-1 md:text-left">
                ...
                <FuseAnimate animation="transition.slideUpIn" delay={300}>
                    <Typography variant="h3" color="inherit" className="font-light">
                        Welcome to Blockchak
                    </Typography>
                </FuseAnimate>

                <FuseAnimate delay={400}>
                    <Typography variant="subtitle1" color="inherit" className="max-w-512 mt-16">
                        Blockchak offers next-gen anti-money laundering solutions and identity verification solutions that allow you to find trusted digital identities quickly and easily while adhering to AML compliance.
                    </Typography>
                </FuseAnimate>

                <FuseAnimate delay={400}>
                    <Typography variant="subtitle1" color="inherit" className="max-w-512 mt-16">
                      Know Your Customer (KYC) is not only a regulatory requirement, it’s an integral component to maintaining the integrity of our financial system, fighting fraud, money laundering, and more importantly for you, to fully comply with regulatory requirements, pass audits with flying colors and to maintain a sound business that can flourish and grow. 
                    </Typography>
                </FuseAnimate>
